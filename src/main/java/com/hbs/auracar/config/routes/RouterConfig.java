    ...
    @RouterOperations(
            {
                    ...
                    @RouterOperation(path = "/api/v1", produces = {MediaType.APPLICATION_JSON_VALUE},
                            method = RequestMethod.DELETE, beanClass = CarHandler.class, beanMethod = "deleteCars",
                            operation = @Operation(operationId = "deleteCars",
                    ...
                    @RouterOperation(path = "/api/v1", produces = {MediaType.APPLICATION_JSON_VALUE},
                            method = RequestMethod.POST, beanClass = CarHandler.class, beanMethod = "createCars",
                            operation = @Operation(operationId = "createCars",
